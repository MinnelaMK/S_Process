...
public class Assign_Publisher_to_the_Subject 
{
	static
	{
...
//		Thread.sleep(100);
//		driver.findElements(By.xpath("//div[2]/div/form/nb-card/nb-card-body/div[1]")).size();
//		System.out.println("Number of rows in table with class 'dataRow': " + count);
		Thread.sleep(100);
		driver.findElement(By.xpath("//div/div/nb-card/nb-card-body/table/tbody/tr[1]/td[1]")).click();
		Thread.sleep(100);
		Assign_Publisher_to_the_Subject obj1 = new Assign_Publisher_to_the_Subject();
		obj1.publish();
