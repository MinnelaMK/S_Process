...
public class Assign_Term_to_Class 
{
	static
	{
		System.setProperty("webdriver.chrome.driver","./driver/chrome_proxy.exe");
	}
	...
	public static void main(String[] args) throws InterruptedException
	{
			...
			driver.findElement(By.xpath("//div[1]/div/div/div/div/nb-layout-column/ngx-classes/div/div/nb-card/nb-card-body/table/tbody/tr[15]/td[3]/div/div")).click();
			Thread.sleep(500);
			
			driver.findElement(By.xpath("//nb-dialog-container/form/nb-card/nb-card-body/nb-select/button")).click();
			Thread.sleep(500);
			driver.findElement(By.id("nb-option-5")).click();
			Thread.sleep(500);
