...
public class CreateClass 
{
	...
	public static String textToEnter = "Class Automation Test";
	...
	public static void main(String[] args) throws InterruptedException 
	{
		...
		Thread.sleep(2000);
		System.out.println("Sending text: " + textToEnter);
		driver.findElement(By.name("className")).sendKeys(textToEnter);
