...
public class Add_Publisher 
{
	...
	public static void main(String[] args) throws InterruptedException
	{
		...
		driver.findElement(By.xpath("//div/div/div/div/div/nb-layout-column/ngx-publishers/div/div/nb-card/nb-card-header/div/button")).click();
		Thread.sleep(500);
		
		/*** entering the publisher name ***/
		driver.findElement(By.id("publisherName")).sendKeys("Publisher BY Automation");
		Thread.sleep(500);
